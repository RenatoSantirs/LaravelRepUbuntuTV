                ...
                <div class="overflow-x-auto relative shadow-md sm:rounded-lg">
                    <div class="max-w-4xl mx-auto py-2">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                            ...
                            <div class="flex flex-col justify-center relative dark:bg-dark-eval-0">
                                <!-- Agregado relative al contenedor del carrusel -->
                                <div class="max-w-xs mx-auto py-9">
                                    <!-- Mover el max-w-4xl al contenedor del carrusel -->
                                    <div class="slick-carousel">
                                        <div>
                                            <img src="{{ asset('storage/public/imagenes/imagen_67765f4d2e43f.jpg') }}"
                                                class="w-96 h-96" alt="Imagen del producto">
                                        </div>
                                    </div>
                                </div>
                                <!-- Botón slick-prev -->
                            ...
                            <div class="flex flex-col justify-center">
                                ...
                                <p class="text-lg mb-4">Marca: Nike</p>
                                <p class="text-lg mb-4">Costo: {{ 1.5 }}</p>
                                <p class="text-lg mb-4">Cantidad disponible: {{ 500 }}</p>
                                <p class="text-lg mb-4">Total: {{ 750 }}</p>
                                <p class="text-lg mb-4">Sexo: Hombre</p>
                                <form method="GET" action="{{ route('articuloview') }}">
                                    <input type="hidden" name="id_usuario" value="1 ">
                                    <input type="hidden" name="imagen" value="public/imagenes/imagen_67765f4d2e43f.jpg">
                                    ...
                                    <input type="hidden" name="costo" value="1.50">
