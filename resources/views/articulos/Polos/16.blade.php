                ...
                <div class="max-w-4xl mx-auto py-2">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                        <div class="flex flex-col justify-center relative dark:bg-dark-eval-0"> <!-- Agregado relative al contenedor del carrusel -->
                            <div class="max-w-xs mx-auto py-9"> <!-- Mover el max-w-4xl al contenedor del carrusel -->
                                <div class="slick-carousel">
                                    <div>
                                        <img src="{{ asset('storage/imagenes/imagen_67aa521080880.jpg') }}" class="w-96 h-96" alt="Imagen del producto">
                                    </div>
                                    <div class="w-96 h-96">
                                        <video controls class="w-96 h-96">
                                            <source src="{{ asset('storage/videos/video_67aa521081ca6.mp4') }}" type="video/mp4">
                        ...
                        <div class="flex flex-col justify-center">
                            <h2 class="text-2xl font-bold mb-4">n2</h2>
                            ...
                            <p class="text-lg mb-4">Sexo: Mujer</p>
                            
                            <form method="GET" action="{{ route('articulovistaprev') }}">
                                <input type="hidden" name="id_usuario" value="{{ 1 }} ">
                                <input type="hidden" name="imagen" value="imagenes/imagen_67aa521080880.jpg">
                                <input type="hidden" name="nombre_ape" value="">
                                <input type="hidden" name="direccion" value="">                                                    
                                <input type="hidden" name="id_articulo" value="{{ 16 }}">
                                <input type="hidden" name="nom_articulo" value="n2">
