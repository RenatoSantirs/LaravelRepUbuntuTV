    ...
    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4  dark:bg-slate-900">
        ...
        <div class="mb-4">
            ...
            <input type="text"
                ...
                id="id_usuario" wire:model="id_usuario">
            @error('id_usuario')
                <div class="block w-full text-red-600">{{ $message }}</div>
            @enderror

            <label for="imagen" class="block text-gray-700 text-sm font-bold mb-2 dark:text-white">Imagen:</label>
            ...
            <label for="nombre_ape" class="block text-gray-700 text-sm font-bold mb-2  dark:text-white">Nombres y
                apellidos:</label>
            <input type="text"
                class="border border-gray-300 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:placeholder-gray-400 dark:bg-slate-800
                            dark:border-slate-800"
            ...
            <label for="direccion" class="block text-gray-700 text-sm font-bold mb-2 dark:text-white">Direccion:</label>
            <input type="text"
                class="border border-gray-300 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:placeholder-gray-400 dark:bg-slate-800
                            dark:border-slate-800"
            ...
            <label for="nom_articulo" class="block text-gray-700 text-sm font-bold mb-2 dark:text-white">Nombre de
                Articulo:</label>
            <input type="text"
                class="border border-gray-300 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:placeholder-gray-400 dark:bg-slate-800
                            dark:border-slate-800"
            ...
            <label for="costo" class="block text-gray-700 text-sm font-bold mb-2 dark:text-white">Costo:</label>
            <input type="text"
                class="border border-gray-300 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:placeholder-gray-400 dark:bg-slate-800
                            dark:border-slate-800"
            ...
            <label for="cantidad" class="block text-gray-700 text-sm font-bold mb-2 dark:text-white">Cantidad:</label>
            ...
            <label for="total" class="block text-gray-700 text-sm font-bold mb-2 dark:text-white">Total:</label>
